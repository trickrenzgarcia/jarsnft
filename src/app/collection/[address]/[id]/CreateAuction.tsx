...
const AuctionFormSchema = z.object({
  ...
  endTimestamp: z.date(),
  floorPrice: z.string().min(1, { message: "Minimum bid price is required" }).refine(value => parseFloat(value) > 0, { message: "Minimum bid price must be greater than 0." }),
  buyoutPrice: z.string().min(1, { message: "Buyout price is required" }).refine(value => parseFloat(value) > 0, { message: "Buyout price must be greater than 0." }),
