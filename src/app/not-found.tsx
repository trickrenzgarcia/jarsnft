...
export default function PageNotFound() {
  return (
    <>
      <Navbar />
      <div className="container flex h-[calc(100vh-250px)] w-full flex-col items-start justify-center p-6 gap-6">
        ...
        <h1 className="text-3xl font-semibold z-10">Cant find the page you were looking for.</h1>
