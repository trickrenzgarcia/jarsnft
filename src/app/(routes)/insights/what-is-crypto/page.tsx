  ...
  return (
    <section>
      ...
      <div id="types">
        ...
        <ol className="space-y-4 mt-2 ml-14 list-decimal leading-loose tracking-wide">
          <li>
