...
export default function LearnNavbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-gray-700 bg-background/95 py-2 backdrop-blur supports-[backdrop-filter]:bg-background/60 md:py-4 ">
      <div className="container flex h-6 md:h-auto items-center justify-center px-4 lg:justify-between lg:px-20">
        ...
        <div className="-ml-4 flex items-center justify-between lg:w-fit lg:justify-normal">
          <div className="w-10 md:w-12"> {/* 40px (10) for small screens and 50px (12) for medium and up */}
            <Image
              src="/assets/Jarsu.png"
              width={50} // Keep the original width for the image
              height={50} // Keep the original height for the image
              alt="Insights Logo"
              className="object-contain" // Ensure the image fits within the container
            />
          </div>
          <Link href="/">
            <h1 className="text-xl md:text-3xl">Insights</h1>
          </Link>
        </div>
