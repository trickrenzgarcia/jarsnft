...
import { NFT, useContractEvents, useValidDirectListings, useValidEnglishAuctions } from "@thirdweb-dev/react";
...
import { updateNftViews } from "@/actions/updateNftViews";
      ...
      <div className="mx-4 mt-4 flex flex-col items-start justify-around gap-8 md:flex-row">
        <div className="w-full md:w-[50svw] lg:w-[50svw] xl:w-[50svw]">
          <div className="flex w-full flex-col gap-4 py-4">
                      ...
                      {loadingListings ? (
                        ...
                        <div className="flex items-baseline gap-4">
                          ...
                          <p className="flex flex-col text-2xl font-bold">
                            ...
                            <span className="text-xs font-normal text-gray-500 dark:text-gray-400"> (PHP {amountInPhp})</span>
                          </p>
                        </div>
                    ...
                    {loadingListings || loadingAuction ? (
                      ...
                      <div className="flex flex-col gap-3">
                        {filteredNft && listings && !listings[0] ? (
                          ...
                          !filteredNft && listings && listings[0] && <BuyButton nft={nft} listings={listings} auctionListing={auctionListing} />
                        )}
                        ...
                        {filteredNft && listings && listings[0] && (
                          <CancelListingButton nft={nft} listings={listings} auctionListing={auctionListing} contractAddress={connectedAddress} />
                        )}
            ...
            {/* <DisplayBidders /> */}
            {auctionListing && auctionListing[0] && (
              <DisplayBidders contractAddress={address} auctionListing={auctionListing} marketPlaceContract={marketPlaceContract} />
            )}
