      ...
      <div className="relative">
        ...
        <div className="z-10 flex h-[calc(100vh-57px)] w-full flex-col items-start justify-center md:container md:flex-row md:items-center md:justify-around">
          ...
          <div className="flex w-auto flex-col justify-center gap-6 p-0 md:w-[50svw] md:p-6">
            ...
            <h1
              className="animate-once animate-duration-[1200ms] animate-ease-out relative mb-6 max-w-4xl animate-fade-up text-center text-6xl font-bold text-zinc-700 dark:text-zinc-100 md:flex md:text-left md:text-7xl"
            ...
            >
              <Alert className="animate-once animate-duration-[1200ms] animate-ease-out animate-flip-up p-6 hover:border-blue-400 hover:bg-blue-500 hover:shadow-lg hover:shadow-blue-500/50">
                <AlertTitle className="text-lg md:text-xl">
