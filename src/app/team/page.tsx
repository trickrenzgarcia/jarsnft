  ...
  return (
    <>
      ...
      <div className='w-full container mx-auto my-auto'>
        <h1 className='text-center text-7xl mt-8'>Meet the Team</h1>
        <p className='text-center my-5 mx-auto px-auto py-auto'>&quot;Driven by passion for excellence&quot;</p>
      </div>
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          {teamMembers.map((member) => (
            <div key={member.name} className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
              <Image className="object-cover w-full h-56 md:h-64 xl:h-80" src={member.image} alt={member.name} width={300} height={500} />
