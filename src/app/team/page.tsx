...
const teamMembers = [
  ...
  },
  {
    ...
    description: "I love Hev Abi",
    image: PatrickImage,
    github: "https://github.com/trickrenzgarcia",
    facebook: "https://www.facebook.com/trickrenz",
    Instagram: "https://www.instagram.com/ricctrick/",
  },
  {
    name: "Rigor Syguat",
    role: "Administrator/ Manager",
    description: "I love Axie Infinity",
    image: RigorImage,
    github: "https://github.com/rgsyg",
    facebook: "https://www.facebook.com/rigor.syguat",
    Instagram: "",
  },
  {
    name: "Jeffrey James Dapar",
    role: "Software Quality Assurance Engineer",
    description: "Crush ko si KC",
    image: JeffImage,
    github: "https://github.com/HeyJepz",
    facebook: "https://www.facebook.com/Jepz.Dapar",
    Instagram: "https://www.instagram.com/jepz_the_great/",
  },
];

const words =
  "We are just students when we tackle this project it was hard for us beginners to grab a latest technology trend but we are eager and passionate to create a platform wherein artists and traders will have opportunities. It took us years to finish this project but we are determined to finish it. We wouldn't be able to finish this without the help of almighty God and our family who support us all the way. We are so grateful to have them in our lives. We are so excited to share this platform to the world and we hope that this will help a lot of people to have a better future.";

const Team = () => {
  return (
    <>
      <Navbar />
      <div className="mx-auto grid h-[830px] w-full grid-cols-1 content-center xl:grid-cols-2">
        <div className="justify-self-center">
          <h1 className="bg-gradient-to-b from-neutral-200 to-neutral-600 bg-clip-text p-5 text-center font-sans text-lg font-bold text-transparent md:text-7xl">
            Team
          </h1>
          <TextGenerateEffect words={words} />
        </div>
        <div className="justify-self-center">
          <div className="mx-auto my-10 flex flex-row flex-wrap justify-center gap-5">
