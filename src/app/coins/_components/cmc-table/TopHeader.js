...
const TopHeader = async () => {
  ...
  return (
    <div className="container">
      <div className="border-bottom ml-12 px-5 py-3">
        ...
        <span className="d-inline-block mr-3">
          <b>Market Cap: </b>
          <span className="text-info">${formattedMarketCapUSD}</span>
          <span>T</span>
        </span>
        <span className="d-inline-block mr-3">
          <b>24h Vol: </b>
          <span className="text-info">${formatVolume}</span>
        </span>
        <span className="d-inline-block mr-3">
          <b>Dominance: </b>
          <span>
            BTC <b className="font-bold">{formattedBTC}%</b> ETH{" "}
            <b className="font-bold">{formattedETH}%</b>
          </span>
        </span>
        <span className="d-inline-block mr-3">
          <b className="mr-1">
