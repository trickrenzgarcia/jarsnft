...
export default function SideNavLeft() {
  ...
  return (
    ...
    <aside className="pt-9 z-30 ml-3 hidden border-r border-gray-300 h-[100vh] right-auto w-[16.5rem] shrink-0 sticky top-16 md:block overflow-y-hidden hover:overflow-y-auto">
