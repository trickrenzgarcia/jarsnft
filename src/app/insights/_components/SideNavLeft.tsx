...
export default function SideNavLeft() {
  ...
  return (
    <aside className="sticky right-auto top-16 z-30 ml-3 hidden h-[100vh] w-[16.5rem] shrink-0 overflow-y-hidden border-r border-gray-400 pt-9 hover:overflow-y-auto md:block">
