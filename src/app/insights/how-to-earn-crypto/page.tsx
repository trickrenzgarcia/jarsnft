...
export default function HowToEarnCrypto() {
  return (
    <section>
      ...
      <div id="buying">
        <h2 className="my-6 text-3xl font-bold">Buy your first Crypto</h2>
      </div>
      <div id="earn">
        <h1 className="my-4 text-4xl font-bold md:text-5xl">
          Ways to Earn Crypto
        </h1>
        <h2 className="my-6 text-3xl font-bold">Gaming</h2>
        <h2 className="my-6 text-3xl font-bold">Mining</h2>
        <h2 className="my-6 text-3xl font-bold">Trading</h2>
      </div>
      <div id="tips">
