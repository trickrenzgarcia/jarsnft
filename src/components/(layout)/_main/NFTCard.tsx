    ...
    <Card className="mx-auto h-[480px]">
      <CardHeader className="relative h-80">
        <Link href={`/collection/${collectionLink}`}>
          <Image src={image} fill alt="NFT" className="rounded-t-lg" style={{ objectFit: "cover" }} />
        </Link>
        <Link href={`/collection/${collectionLink}`}>
          <div className="absolute top-[17rem] z-10 h-16 w-16 rounded-md bg-white">
            <Image
              className="h-full w-full p-[0.15rem]"
              src={logo}
              width={64}
              height={64}
              style={{
        ...
        <div className="flex w-full justify-between">
          <div className="flex flex-col">
            ...
            <p className="font-bold">
              {formatNumber(floor)} <span className="font-normal text-red-500">-9%</span>
            </p>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <p className="font-bold">
              {formatNumber(volume)} <span className="font-normal text-red-500">-42.27%</span>
            </p>
          </div>
        </div>
      </CardFooter>
