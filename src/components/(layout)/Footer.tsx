      ...
      <section className='max-w-screen-xl mx-auto'>
        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-5 gap-y-10 mb-14'>
          ...
          <div className='flex flex-col gap-y-5'>
            ...
            <Link href='/learn' className='hover:underline'>How to sell an NFT using Jars</Link>
            <Link href='/learn' className='hover:underline'>What is a crypto wallet?</Link>
            <Link href='/learn' className='hover:underline'>What is cryptocurrency?</Link>
            ...
            <Link href='/learn' className='hover:underline'>What is web3?</Link>
          </div>
          <div className='flex flex-col gap-y-5'>
            <h1 className='font-semibold mb-1'>Resource</h1>
            <Link href='/learn' className='hover:underline'>All Guides</Link>
            <Link href='/learn' className='hover:underline'>Getting Started</Link>
            <Link href='/blog' className='hover:underline'>Blog</Link>
            <Link href='/community-standards' className='hover:underline'>Community standards</Link>
            <Link href='/taxes' className='hover:underline'>Taxes</Link>
          </div>
        </div>
