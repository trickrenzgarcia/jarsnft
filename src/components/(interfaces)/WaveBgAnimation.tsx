      ...
      <div className="waveDiv animation-wave">
        <div className="wave-content-wrapper first-wave">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://www.yudiz.com/codepen/wave-animation/first-wave.png')",
            }}
          ></div>
        </div>
        <div className="wave-content-wrapper second-wave">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://www.yudiz.com/codepen/wave-animation/second-wave.png')",
            }}
          ></div>
        </div>
        <div className="wave-content-wrapper third-wave">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://www.yudiz.com/codepen/wave-animation/third-wave.png')",
            }}
          ></div>
        </div>
      </div>
